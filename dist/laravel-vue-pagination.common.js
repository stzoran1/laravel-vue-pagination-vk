...
return _c('nav',{staticClass:"pagination"},[_c('div',{staticClass:"column"},[(computed.total > computed.perPage)?_c('ul',{staticClass:"pages"},_vm._l((computed.pageRange),function(page,key){return _c('li',{key:key,class:{ 'active': page == computed.currentPage }},[_c('a',_vm._g({attrs:{"href":"#"}},pageButtonEvents(page)),[_vm._v(_vm._s(page))])])})):_vm._e()]),_c('div',{staticClass:"column text-right hidden-xs-down"},[_c('a',_vm._g({staticClass:"btn btn-outline-secondary btn-sm",attrs:{"href":"#","aria-label":_vm.lang('fe.next'),"tabindex":!computed.nextPageUrl && -1}},nextButtonEvents),[_vm._v(_vm._s(_vm.lang('fe.next'))+" "),_c('i',{staticClass:"icon-chevron-right"})])])])}}])})}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/LaravelVuePagination.vue?vue&type=template&id=0593909e&
