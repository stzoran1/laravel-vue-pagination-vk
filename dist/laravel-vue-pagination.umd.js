...
return _c('div',{staticClass:"column text-right hidden-xs-down"},[_c('a',_vm._g({staticClass:"btn btn-outline-secondary btn-sm",attrs:{"href":"#","aria-label":_vm.lang('fe.next'),"tabindex":!computed.nextPageUrl && -1}},nextButtonEvents),[_vm._v(_vm._s(_vm.lang('fe.next'))+" "),_c('i',{staticClass:"icon-chevron-right"})])])}}])})}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/LaravelVuePagination.vue?vue&type=template&id=4941b921&
